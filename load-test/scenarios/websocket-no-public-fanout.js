...
export default function () {
    ...
    console.log(
        `[VU ${__VU}] Starting WebSocket test (NO PUBLIC FANOUT)`
    );
            ...
            socket.on(
                ...
                function (rawData) {
                    ...
                    if (
                        ...
                        /*
                         * ==================================================
                         * Generate chat message to determine room ID
                         * ==================================================
                         */
                        ...
                        /*
                         * ==================================================
                         * SUBSCRIBE to room-specific topic (NOT /topic/public)
                         * ==================================================
                         *
                         * This is the key difference from websocket-concurrency.js.
                         * Instead of subscribing to /topic/public (which causes N² fan-out),
                         * we subscribe only to the room-specific topic for this VU's messages.
                         *
                         * This means:
                         * - Original: All VUs receive all messages (N² fan-out)
                         * - This test: Each VU receives only its own messages (no fan-out)
                         */
                        ...
                        console.log(
                            `[VU ${__VU}] Subscribing to room topic: ${roomTopic}`
                        );
